...
if (isset($_POST['edit'])) {
    ...
    // Update data
    $query = "UPDATE kompensasi SET nim = '$nim', jam = '$jam', tanggal = '$tanggal', kegiatan = '$kegiatan' , validasi = '$validasi', status = '$status' WHERE id = '$id'";
                                                            ...
                                                            <form action="" method="POST">
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <select class="form-control" id="kegiatan" name="kegiatan" required>
                                                                        ...
                                                                        <option value="Buat Spanduk">Buat Spanduk</option>
                                                                    </select>
                                                                </div>
                                                                <div class="form-group">
